...
public class Game_Controller : MonoBehaviour
{
    ...
    public Dictionary<string, string> getCharDesc()
    {
        return new Dictionary<string, string>() {
            ...
            { "Magician", "даёт возможность получить новые карты из колоды в обмен на свои, либо обменять все имеющиеся у себя в руке карты на все карты, имеющиеся в руке у другого игрока."},
